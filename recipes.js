...
const myKeyPath1 = "hel_keyfiles/5jbNEm3Js83e7kNpbpsTVv7rbFnT8P6mszgcrZqYWrmQKqSQtiZh.json";
...
//    .catch((e) => console.error(e));
  ...
  .then(res => brambl1.requests.lookupBalancesByAddresses({addresses: [address1, address2]}))
