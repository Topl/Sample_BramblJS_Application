...
export default class KeyfilesDAO {
    ...
    */
     ...
     */
    static async addKeyfile(address_id, email, keyfile, date) {
        try {
            keyfile = keyfile || {}
    ...
    // static async updateKeyfile(keyfileId, email, date) {
    //     try {
    ...
    //     }
    // }
    // This has been commented out as if we are not storing passwords, keyfiles should not be able to be edited. 
    /**
