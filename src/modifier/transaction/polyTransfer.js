...
class PolyTransfer extends TransferTransaction {
    ...
    static async createRaw(toReceive, senders, changeAddress, fee, data, bramblHelper) {
        let obj = {};
        let self = this;
        ...
        return TransferTransaction.getSenderBoxesAndCheckPolyBalance(
            ...
            const inputOutputObj = self.ioTransfer(txInputState, toReceive, changeAddress, fee, amtToSpend);
            ...
            return new PolyTransfer(inputOutputObj.inputs, inputOutputObj.outputs, new Map(), fee, Date.now(), data);
        });
    }
